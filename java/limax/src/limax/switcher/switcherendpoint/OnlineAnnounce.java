...
public class OnlineAnnounce extends limax.net.Protocol {
	...
	public OnlineAnnounce(int _errorSource_, int _errorCode_, long _sessionid_, long _flags_, java.util.HashMap<Integer, limax.defines.VariantDefines> _variantdefines_, String _scriptdefines_) {
