...
public class OnlineAnnounce extends limax.net.Protocol {
	...
	public OnlineAnnounce(long _sessionid_, long _mainid_, String _uid_, limax.codec.Octets _clientaddress_, long _flags_, java.util.HashMap<Integer, Byte> _sessiontype_) {
