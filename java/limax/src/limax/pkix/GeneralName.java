...
public class GeneralName {
	public enum Type {
		...
		private ASN1Tag tag = new ASN1Tag(TagClass.ContextSpecific, ordinal());
	}
	...
	public static GeneralName createRFC822Name(String email) throws limax.codec.RFC2822Address.Exception {
	...
	public static GeneralName createUniformResourceIdentifier(URI uri) {
		return new GeneralName(new ASN1IA5String(Type.uniformResourceIdentifier.tag, uri.toString()));
	}
