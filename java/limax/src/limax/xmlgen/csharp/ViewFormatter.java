...
public class ViewFormatter {
	...
	public void printDefine(PrintStream ps, boolean isTemp) {
		...
		ps.println("		internal " + view.getLastName() + "(ViewContext vc) : base(vc) {}");
		...
		if (ViewLifecycle.temporary == view.getLifecycle()) {
			...
			ps.println(
					"			return getInstance(instanceindex, limax.endpoint.Endpoint.getDefaultEndpointManager());");
			ps.println("		}");
			ps.println();
