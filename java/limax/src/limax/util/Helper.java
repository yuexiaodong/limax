...
public final class Helper {
	...
	public static byte[] fromHexString(String s) {
		...
		byte[] bs = new byte[l];
		for (int i = 0; i < l; i++)
			bs[i] = (byte) (0xff & Integer.parseInt(s.substring(i * 2, i * 2 + 2), 16));
		return bs;
	}
	...
	private static final BigInteger dh_group[] = new BigInteger[] { null,
			...
			new BigInteger(
					...
					16) // dh_group18,rfc3526 8192
	};

	public static boolean isDHGroupSupported(int group) {
		return group >= 0 && group < dh_group.length && dh_group[group] != null;
	}

	public static BigInteger getDHGroup(int group) {
		return isDHGroupSupported(group) ? dh_group[group] : null;
	}

	public static BigInteger makeDHRandom() {
		return new BigInteger(1, makeRandValues(16));
	}
