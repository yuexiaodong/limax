...
namespace limax {
	...
	public:
		...
		public:
			...
			virtual ~ViewCreator();
		public:
			virtual View* createView(std::shared_ptr<helper::AbstractViewContext>) = 0;
		};
		...
		public:
			virtual View* createView(std::shared_ptr<helper::AbstractViewContext> vc)
			{
	...
	public:
		View(std::shared_ptr<helper::AbstractViewContext>);
		virtual ~View();
	private:
	...
	public:
		TemporaryView(std::shared_ptr<helper::AbstractViewContext>);
