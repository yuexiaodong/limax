...
namespace limax {
	namespace helper {
		...
		public:
			DynamicView(std::shared_ptr<limax::helper::AbstractViewContext> vc, int32_t providerId, std::shared_ptr<limax::ViewDefine> viewDefine)
		...
		class DynamicTemporaryView : public TemporaryView, public GetViewInfoInterface
		{
			...
			VariantView*	variantView;
		public:
			DynamicTemporaryView(std::shared_ptr<limax::helper::AbstractViewContext> vc, int32_t providerId, std::shared_ptr<limax::ViewDefine> viewDefine, std::shared_ptr<TemporaryViewHandler> _handler)
