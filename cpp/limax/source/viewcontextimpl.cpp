...
namespace limax {
	...
	namespace helper {
		namespace variant {
			...
			public:
				virtual View* createView(std::shared_ptr<limax::helper::AbstractViewContext> vc) override
				{
		...
		View* VariantViewContextImpl::createView(std::shared_ptr<limax::helper::AbstractViewContext> vc, std::shared_ptr<limax::ViewDefine> define)
		{
			if (define->isTemporary())
